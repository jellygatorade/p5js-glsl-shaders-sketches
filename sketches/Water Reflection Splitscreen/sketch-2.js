const instantiate2 = (p) => {
  let canvasParent, wrShader, img;

  canvasParent = document.getElementById("p5-canvas-1");
  ...
  p.preload = function () {
    ...
    // img = p.loadImage(
    //   "../../images/Cumulus-Congestus-Grass-Cleaned-1024-1024.jpg"
    // );
    img = p.loadImage("../../images/sun-fence-1024x1024.jpg");
...
let p5inst2 = new p5(instantiate2);
